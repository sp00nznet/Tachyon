...
public class Constants {
    ...
    public static final Color SYS_ENERGY_BATTERY_OUTLINE = new Color(226, 114, 31);
    public static final Color SYS_ENERGY_ION_STORM = new Color(40, 210, 230);
    ...
    public static final Color SHIP_HEALTH_LOW = new Color(255, 92, 92);
